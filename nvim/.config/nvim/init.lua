...
require("lazy").setup({
	...
	--
	-- Rory - I tried to add omnisharp extended as per chatgpt's instructions
	{
	...
	-- Rory - My attempt at adding vscode dark to nvim
	-- {
	-- 	"Mofiqul/vscode.nvim",
	-- 	lazy = false,
	-- 	priority = 1000,
...
--
-- Rory's tab and space settings
vim.o.softtabstop = 0

-- Rory's attempt to make neovim transparent
